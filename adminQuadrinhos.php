...
$quadrinistas_quadrinhos  =  $obj_quadrinistas_quadrinhos->exibirTodosQuadrinhos();
...
<body>
    ...
    <main role="main" class="container-fluid">
        <div class="row">
            <a class="btn btn-info" style="margin: 10px;" href="#quadrinhos">Quadrinhos</a>

            <a class="btn btn-info" style="margin: 10px;" href="#quadrinistas_quadrinho">Quadrinistas de Quadrinhos</a>

        </div>

        <div class="row" id="quadrinhos">
            <div class="col">
                <h2>Quadrinhos cadastrados</h2>
                <a href="#" id="encomendar" class="NewBtn scrollto" data-toggle="modal" data-target="#AddQuadrinho">
                    <b> Novo Quadrinho</b> <i class="fa fa-plus-circle"></i></a>
        ...
        <div class="row" id="quadrinistas_quadrinho">
            <div class="col">
                <h2>Autores de Quadrinhos cadastrados</h2>
                <a href="#" id="encomendar" class="NewBtn scrollto" data-toggle="modal" data-target="#AddAutorQuadrinho">
                    <b> Novo Autor de Quadrinho</b> <i class="fa fa-plus-circle"></i></a>
                <table class="table table-striped">
    ...
    <!-- Modal -->
    <div class="modal fade" id="AddQuadrinho" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cadastre um Quadrinho</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form">
                        ...
                        <form action="APIs/Addquadrinho.php" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <input type="hidden" class="form-control" name="is_quadrinho" id="is_quadrinho" value="1" >
    ...
    <!-- Modal Autor Quadrinho-->
    <div class="modal fade" id="AddAutorQuadrinho" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cadastre um Autor de Quadrinho</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="editquadrinho" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Altere um quadrinho</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
